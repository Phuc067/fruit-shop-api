...
public class OrderServiceImpl implements OrderService {
	...
	public ResponseObject createOrder(OrderRequest request) {
		...
		Order order =  Order.builder()
				.orderDate(TimeUtils.getInstantNow())
				.state(request.getPaymentMethod().equals(PaymentMethod.VNPAY.getDisplayName())? OrderStatus.AWAITING_PAYMENT:OrderStatus.PENDING)
				.recipientName(shippingInfo.getRecipientName())
				.recipientAddress(shippingInfo.getShippingAdress())
